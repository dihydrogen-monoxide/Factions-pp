...
use HittmanA\factionspp;
use HittmanA\factionspp\commands\CreateCommand;
...
class MainClass extends PluginBase implements Listener {
    ...
    public function onEnable() {
        ...
        $this->getCommand("factionspp")->setExecutor(new CreateCommand($this));
...
##$power -= 10
    public function hasFaction($displayName){
            ...
            //Is the command sender a player?
                if($sender instanceof Player) {
                  //Is the subcommand create?
                        if ($subcmd === "info") {
                            if($playerRegistered === true && $this->hasFaction($displayName)) {
